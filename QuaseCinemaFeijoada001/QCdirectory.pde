...
public void QCrandomMov(int layer){
  ...
  switch (layer) { 
      case 0: // layer 1
        ...
        //println ("tempString: "+tempString+"\n");
        myMovie1.stop(); myMovie1.delete(); myMovie1 = new GSMovie(this, tempString);
        myMovie1.jump(random(myMovie1.duration())); myMovie1.read(); myMovie1.play();
      ...
      case 1: // layer 2
        ...
        myMovie2.stop(); myMovie2.delete(); myMovie2 = new GSMovie(this, tempString);
        myMovie2.jump(random(myMovie2.duration())); myMovie2.read(); myMovie2.play();
      ...
      case 2: // layer 3
        ...
        myMovie3.stop(); myMovie3.delete(); myMovie3 = new GSMovie(this, tempString);
        myMovie3.jump(random(myMovie3.duration())); myMovie3.read(); myMovie3.play();
      ...
      case 3: // layer 4
        ...
        myMovie4.stop(); myMovie4.delete(); myMovie4 = new GSMovie(this, tempString);
        myMovie4.jump(random(myMovie4.duration())); myMovie4.read(); myMovie4.play();
