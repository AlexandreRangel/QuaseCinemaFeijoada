...
PGraphics quadGraphics1, quadGraphics2, quadGraphics3, quadGraphics4, outputGL;
...
// effects pre setup
public boolean effectInvert1 = false; 
public boolean effectInvert2 = false;
public boolean effectInvert3 = false; 
public boolean effectInvert4 = false; 

public boolean effectPosterize1 = false; 
public boolean effectPosterize2 = false;
public boolean effectPosterize3 = false; 
public boolean effectPosterize4 = false;

public boolean effectPaint1 = false; 
public boolean effectPaint2 = false;
public boolean effectPaint3 = false; 
public boolean effectPaint4 = false;

public boolean effectRG1 = false; 
public boolean effectRG2 = false;
public boolean effectRG3 = false; 
public boolean effectRG4 = false;

public boolean effectRB1 = false; 
public boolean effectRB2 = false;
public boolean effectRB3 = false; 
public boolean effectRB4 = false;

public boolean effectBG1 = false; 
public boolean effectBG2 = false;
public boolean effectBG3 = false; 
public boolean effectBG4 = false;

public boolean effectBW1 = false; 
public boolean effectBW2 = false;
public boolean effectBW3 = false; 
public boolean effectBW4 = false;
public int effectBWlimit1 = 127; 
public int effectBWlimit2 = 127;
public int effectBWlimit3 = 127; 
public int effectBWlimit4 = 127;

public boolean effectContrast1 = false; 
public boolean effectContrast2 = false;
public boolean effectContrast3 = false; 
public boolean effectContrast4 = false;
public int effectContrastLimit1 = 0; 
public int effectContrastLimit2 = 0;
public int effectContrastLimit3 = 0; 
public int effectContrastLimit4 = 0;

public boolean effectSaturation1 = false; 
public boolean effectSaturation2 = false;
public boolean effectSaturation3 = false; 
public boolean effectSaturation4 = false;
public int effectSaturationLimit1 = 0; 
public int effectSaturationLimit2 = 0;
public int effectSaturationLimit3 = 0; 
public int effectSaturationLimit4 = 0;

public boolean effectHue1 = false; 
public boolean effectHue2 = false;
public boolean effectHue3 = false; 
public boolean effectHue4 = false;
public int effectHueLimit1 = 0; 
public int effectHueLimit2 = 0;
public int effectHueLimit3 = 0; 
public int effectHueLimit4 = 0;

public int paintAmount1 = 0; 
public int paintAmount2 = 0;
public int paintAmount3 = 0; 
public int paintAmount4 = 0;
...
void setup() {
  ...
  if (System.getProperty("user.name").equals("rangel")) { 
  ...
  if (OSname == "Windows 7") { 
    GSVideo.localGStreamerPath = sketchPath("code\\gstreamer\\windows64");
  }
...
public void draw() {
  ...
  if (changeMovie && selectedLayer == 1) {
    myMovie2.delete(); 
    myMovie2 = new GSMovie(this, newMovie); 
    myMovie2.play();
    layer2in = 0; 
    layer2out = 0;
    if (layer2loop) { 
  ...
  if (changeMovie && selectedLayer == 2) {
    myMovie3.delete(); 
    myMovie3 = new GSMovie(this, newMovie); 
    myMovie3.play();
    layer3in = 0; 
    layer3out = 0;
    if (layer3loop) { 
  ...
  if (changeMovie && selectedLayer == 3) {
    myMovie4.delete(); 
    myMovie4 = new GSMovie(this, newMovie); 
    myMovie4.play();
    layer4in = 0; 
    layer4out = 0;
    if (layer4loop) { 
  ...
  if (layer1visibility) {
    ...
    // openGL compositing
    if (layerComposite1select != 0) { 
      gl.glDisable(GL.GL_DEPTH_TEST); 
      gl.glEnable(GL.GL_BLEND);
    } // prepare blend
    if (layerComposite1select == 1) { 
      gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
    } // lighten
    if (layerComposite1select == 2) { 
  ...
  if (layer2visibility) {
    ...
    // openGL compositing
    if (layerComposite2select != 0) { 
      gl.glDisable(GL.GL_DEPTH_TEST); 
      gl.glEnable(GL.GL_BLEND);
    } // prepare blend
    if (layerComposite2select == 1) { 
      gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
    } // lighten
    if (layerComposite2select == 2) { 
      gl.glBlendFunc(GL.GL_DST_COLOR, GL.GL_SRC_COLOR);
      ;
    } // darken
  ...
  if (layer3visibility) {
    ...
    // openGL compositing
    if (layerComposite3select != 0) { 
      gl.glDisable(GL.GL_DEPTH_TEST); 
      gl.glEnable(GL.GL_BLEND);
    } // prepare blend
    if (layerComposite3select == 1) { 
      gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
    } // lighten
    if (layerComposite3select == 2) { 
      gl.glBlendFunc(GL.GL_DST_COLOR, GL.GL_SRC_COLOR);
      ;
    } // darken
  ...
  if (layer4visibility) {
    ...
    // openGL compositing
    if (layerComposite4select != 0) { 
      gl.glDisable(GL.GL_DEPTH_TEST); 
      gl.glEnable(GL.GL_BLEND);
    } // prepare blend
    if (layerComposite4select == 1) { 
      gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
    } // lighten
    if (layerComposite4select == 2) { 
      gl.glBlendFunc(GL.GL_DST_COLOR, GL.GL_SRC_COLOR);
      ;
    } // darken
  ...
  if (recordingMovie) {
    loadPixels();
    //outputGL.getTexture().getImage(img);
    mm.addFrame(pixels);
    //mm.addFrame(pixels);
    ...
    // Syphon output
  if (syphonOutput) { 
    syphon.sendImage(outputGL);
  }

  // needs to change resolution?
  if (changeResolution != 100) { 
    QCchangeResolution();
  }
