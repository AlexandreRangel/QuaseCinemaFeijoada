...
audioAnalysis1.plugTo(parent,"audioAnalysis1");
...
audioAnalysis2.plugTo(parent,"audioAnalysis2");
...
audioAnalysis3.plugTo(parent,"audioAnalysis3");
...
audioAnalysis4.plugTo(parent,"audioAnalysis4");
...
//
  ...
  if (posH1 && posH1audio) { posH1value = map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posH1value").setValue(posH1value); } }
  if (posV1 && posV1audio) { posV1value = map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posV1value").setValue(posV1value); } }
  if (sizeH1 && sizeH1audio) { sizeH1value = map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeH1value").setValue(sizeH1value); } }
  if (sizeV1 && sizeV1audio) { sizeV1value = map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeV1value").setValue(sizeV1value); } }
  if (rotX1 && rotX1audio) { rotX1value = int(map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotX1value").setValue(rotX1value); } }
  if (rotY1 && rotY1audio) { rotY1value = int(map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotY1value").setValue(rotY1value); } }
  if (rotZ1 && rotZ1audio) { rotZ1value = int(map(fft.getAvg(FFTband1)*FFTbandScale1*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotZ1value").setValue(rotY1value); } }
  
  if (posH2 && posH2audio) { posH2value = map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posH2value").setValue(posH2value); } }
  if (posV2 && posV2audio) { posV2value = map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posV3value").setValue(posV2value); } }
  if (sizeH2 && sizeH2audio) { sizeH2value = map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeH2value").setValue(sizeH2value); } }
  if (sizeV2 && sizeV2audio) { sizeV2value = map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeV2value").setValue(sizeV2value); } }
  if (rotX2 && rotX2audio) { rotX2value = int(map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotX2value").setValue(rotX2value); } }
  if (rotY2 && rotY2audio) { rotY2value = int(map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotY2value").setValue(rotY2value); } }
  if (rotZ2 && rotZ2audio) { rotZ2value = int(map(fft.getAvg(FFTband2)*FFTbandScale2*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotZ2value").setValue(rotZ2value); } }
  
  if (posH3 && posH3audio) { posH3value = map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posH3value").setValue(posH3value); } }
  if (posV3 && posV3audio) { posV3value = map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posV3value").setValue(posV3value); } }
  if (sizeH3 && sizeH3audio) { sizeH3value = map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeH3value").setValue(sizeH3value); } }
  if (sizeV3 && sizeV3audio) { sizeV3value = map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeV3value").setValue(sizeV3value); } }
  if (rotX3 && rotX3audio) { rotX3value = int(map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotX3value").setValue(rotX3value); } }
  if (rotY3 && rotY3audio) { rotY3value = int(map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotY3value").setValue(rotY3value); } }
  if (rotZ3 && rotZ3audio) { rotZ3value = int(map(fft.getAvg(FFTband3)*FFTbandScale3*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotZ3value").setValue(rotZ3value); } }
  
  if (posH4 && posH3audio) { posH4value = map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posH4value").setValue(posH4value); } }
  if (posV4 && posV3audio) { posV4value = map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("posV4value").setValue(posV4value); } }
  if (sizeH4 && sizeH3audio) { sizeH4value = map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeH4value").setValue(sizeH4value); } }
  if (sizeV4 && sizeV3audio) { sizeV4value = map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-1.0,1.0); if (cp5.getTab("Transform").isActive()) { cp5.controller("sizeV4value").setValue(sizeV4value); } }
  if (rotX4 && rotX3audio) { rotX4value = int(map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotX4value").setValue(rotX4value); } }
  if (rotY4 && rotY3audio) { rotY4value = int(map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotY4value").setValue(rotY4value); } }
  if (rotZ4 && rotZ3audio) { rotZ4value = int(map(fft.getAvg(FFTband4)*FFTbandScale4*2.0,0.0,256.0,-180,180)); if (cp5.getTab("Transform").isActive()) { cp5.controller("rotZ4value").setValue(rotZ4value); } }
  

  if (cp5.getTab("Effects").isActive()) { // effects tab
    if (effectContrastAudio1) { cp5.controller("effectContrastLimit1").setValue(effectContrastLimit1); }
    if (effectContrastAudio2) { cp5.controller("effectContrastLimit2").setValue(effectContrastLimit2); }
    if (effectContrastAudio3) { cp5.controller("effectContrastLimit3").setValue(effectContrastLimit3); }
    if (effectContrastAudio4) { cp5.controller("effectContrastLimit4").setValue(effectContrastLimit4); }

    if (effectSaturationAudio1) { cp5.controller("effectSaturationLimit1").setValue(effectSaturationLimit1); }
    if (effectSaturationAudio2) { cp5.controller("effectSaturationLimit2").setValue(effectSaturationLimit2); }
    if (effectSaturationAudio3) { cp5.controller("effectSaturationLimit3").setValue(effectSaturationLimit3); }
    if (effectSaturationAudio4) { cp5.controller("effectSaturationLimit4").setValue(effectSaturationLimit4); }

    if (effectHueAudio1) { cp5.controller("effectHueLimit1").setValue(effectHueLimit1); }
    if (effectHueAudio2) { cp5.controller("effectHueLimit2").setValue(effectHueLimit2); }
    if (effectHueAudio3) { cp5.controller("effectHueLimit3").setValue(effectHueLimit3); }
    if (effectHueAudio4) { cp5.controller("effectHueLimit4").setValue(effectHueLimit4); }
    
    if (effectAnaglyphAudio1) { cp5.controller("effectAnaglyphAmount1").setValue(effectAnaglyphAmount1); }
    if (effectAnaglyphAudio2) { cp5.controller("effectAnaglyphAmount2").setValue(effectAnaglyphAmount2); }
    if (effectAnaglyphAudio3) { cp5.controller("effectAnaglyphAmount3").setValue(effectAnaglyphAmount3); }
    if (effectAnaglyphAudio4) { cp5.controller("effectAnaglyphAmount4").setValue(effectAnaglyphAmount4); }
...
if (cp5.getTab("Audio").isActive()) { // audio tab

  // draw lines
  //fft.forward(audioIn.mix);
  strokeWeight(2); stroke(0,255,0); // green
  for (int i=0; i < fft.avgSize(); i++) { 
    if (audioAnalysis1){line((i*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*0),512,(i*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*0),512 -map(fft.getAvg(i),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis1
    if (audioAnalysis2){line((i*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*1),512,(i*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*1),512 -map(fft.getAvg(i),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis2
    if (audioAnalysis3){line((i*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*2),512,(i*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*2),512 -map(fft.getAvg(i),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis2
    if (audioAnalysis4){line((i*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*3),512,(i*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*3),512 -map(fft.getAvg(i),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis2
  } // end for
  
  // red analysis line
  strokeWeight(4); stroke(255,0,0,200); // red
  if (audioAnalysis1){line((FFTband1*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*0),512,(FFTband1*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*0),512 -map((fft.getAvg(FFTband1)*FFTbandScale1),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis1
  if (audioAnalysis2){line((FFTband2*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*1),512,(FFTband2*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*1),512 -map((fft.getAvg(FFTband2)*FFTbandScale2),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis2
  if (audioAnalysis3){line((FFTband3*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*2),512,(FFTband3*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*2),512 -map((fft.getAvg(FFTband3)*FFTbandScale3),0.0,256.0,0.0,128.0) *10);}// end if audioAnalysis2
  if (audioAnalysis4){line((FFTband4*audioBarWidth) + (audioBarWidth/2) + 10+(columnWidth*3),512,(FFTband4*audioBarWidth)+(audioBarWidth/2) + 10+(columnWidth*3),512 -map((fft.getAvg(FFTband4)*FFTbandScale4),0.0,256.0,0.0,128.0) *10);} // end if audioAnalysis2
  // //println ("audio1: " + int(fft.getAvg(FFTband1)*FFTbandScale1));
